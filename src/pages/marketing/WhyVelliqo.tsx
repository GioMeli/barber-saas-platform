...
const questions = [
  ...
  ['Will it be difficult for my staff to learn?', 'The product is designed around familiar daily workflows: calendar, customers, services and clear actions. The guided Tour, Training Portal, PDF guides and course videos are designed to reduce training time.'],
  ...
  ['Does it work for more than one staff member?', 'Yes. The platform supports team schedules, staff availability, customer assignment and business-level visibility. Each authorised professional can use a focused personal Staff Portal for their own schedule and daily work.'],
  ['What is the Staff Portal?', 'The Staff Portal is a personal, business-controlled workspace for each authorised professional. It keeps their schedule, appointments and profile synchronized with the owner workspace, supports secure email access, and can be installed as a personal app on plans that include Staff Apps.'],
      ...
      <main>
        <section className="relative overflow-hidden border-b border-slate-200 bg-slate-950 text-white">
          ...
          <div className="relative mx-auto grid max-w-[1340px] items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:px-8 lg:py-28">
            ...
            <div className="relative">
              <div className="rounded-[2rem] border border-white/10 bg-white/[.05] p-5 shadow-[0_35px_100px_rgba(0,0,0,.35)] backdrop-blur"><ApprovedArtwork src="/marketing/approved/calendar-two-devices-transparent.png" alt="Velliqo owner calendar across desktop and mobile" loading="eager" className="max-w-[760px]" /></div>
        ...
        <section className="mx-auto max-w-[1280px] px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Reason icon={<Users className="h-5 w-5" />} title="Built for the full team" text="Owners gain visibility while professionals work from a focused personal Staff Portal synchronized with the business in real time." />
        ...
        <section className="border-y border-slate-200 bg-[#f0edff]">
          <div className="mx-auto grid max-w-[1280px] items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-28">
            <div className="rounded-[2rem] border border-violet-200 bg-white p-5 shadow-[0_28px_90px_rgba(76,29,149,.15)]"><ApprovedArtwork src="/marketing/approved/staff-page-two-devices-transparent.png" alt="Velliqo personal Staff Portal on desktop and mobile" className="max-w-[820px]" /></div>
            <div>
              ...
              <p className="mt-5 text-base leading-7 text-slate-600">A high-quality platform earns trust through clarity. Velliqo uses consistent navigation, familiar scheduling patterns, guided setup and responsive layouts, while each professional receives a focused Staff Portal instead of the full owner administration workspace.</p>
              <div className="mt-7 space-y-4"><Line title="Clear daily priorities" text="The dashboard surfaces what requires attention now." /><Line title="Personal Staff Portal" text="Professionals see their own schedule and daily actions in a secure workspace that stays synchronized with the owner." /><Line title="Consistent terminology" text="Labels adapt to the selected business without changing the core experience." /><Line title="Progressive depth" text="New users can begin simply while advanced capabilities remain available when needed." /></div>
            </div>
          </div>
        </section>
