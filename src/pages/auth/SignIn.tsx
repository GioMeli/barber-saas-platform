      ...
      <div className="grid h-full lg:grid-cols-[0.96fr_1.04fr]">
        <section className="relative hidden overflow-hidden bg-zinc-950 px-8 py-6 text-white lg:flex lg:flex-col lg:justify-between xl:px-12 xl:py-8">
          ...
          <div className="relative">
            <Link to="/" className="inline-flex items-center gap-3">
              <img src="/brand/velliqo-mark.png" alt="Velliqo" className="h-10 w-10 object-contain" />
        ...
        <main className="relative flex h-full items-center justify-center overflow-hidden px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full max-w-lg">
            <div className="mb-4 flex items-center gap-3 lg:hidden"><img src="/brand/velliqo-mark.png" alt="Velliqo" className="h-10 w-10 object-contain" /><div><div className="font-extrabold">Velliqo</div><div className="text-xs text-muted-foreground">{t('auth.business_access')}</div></div></div>
