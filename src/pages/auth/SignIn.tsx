      ...
      <div className="grid h-full lg:grid-cols-[0.96fr_1.04fr]">
        ...
        <main className="relative flex h-full items-center justify-center overflow-hidden px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full max-w-lg">
            <div className="mb-4 flex items-center gap-3 lg:hidden"><img src="/brand/velliqo-mark-transparent-v2.png" alt="Velliqo" className="h-10 w-10 object-contain" /><div><div className="font-extrabold">Velliqo</div><div className="text-xs text-muted-foreground">{t('auth.business_access')}</div></div></div>
